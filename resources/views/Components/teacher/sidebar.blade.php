...
<div class="sidenav-header d-flex align-items-center">
  ...
  <a class="navbar-brand m-0 d-flex align-items-center" href="{{ route('teacher.dashboard') }}">
    <img src="{{ asset('assets/images/logoest.png') }}" class="navbar-brand-img" alt="main_logo">
    <span class="ms-2 font-weight-bold">ESTO EDU-TECH</span>
  </a>
</div>
   <hr class="horizontal dark mt-0">
    <div class="w-auto">
        <ul class="navbar-nav sidenavbare">
            <li class="nav-item">
            ...
            <!-- resources/views/Components/teacher/sidebar.blade.php -->

            <li class="nav-item">
                <a class="nav-link {{ Request::is('teacher/LesNotes') ? 'active' : '' }}" href="{{ route('thenotes')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('teacher/Document/subjects') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('teacher/absences') ? 'active' : '' }}" href="{{ route('teacher.absences') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @if(auth()->user()->StatusDep == 'true')
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Chéf de Département</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('teacher/chefDepartement') ? 'active' : '' }}" href="{{ route('teacher.chefDep') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 640 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            {{-- Partie de chef de filieres --}}
            @if(auth()->user()->StatusFil == 'true')
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Chéf de Filières</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('teacher/HourlyLoadsManagement') ? 'active' : '' }}" href="{{ route('hourlyloads') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <g transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(603.000000, 0.000000)">
                                            ...
                                            <path class="color-background" d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z"></path>
                                        </g>
                                    </g>
                                </g>
                            </g>
                    ...
                    <span class="nav-link-text ms-1">Charge horaire</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('teacher/ChefFil') ? 'active' : '' }}" href="{{route('ChefFil')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 640 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>Enseignant</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('logout') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="20px" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>Logout</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
