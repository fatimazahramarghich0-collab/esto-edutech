                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="{{ $student->photo }}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                        </div>
                    </div>
                    <div class="col-auto my-auto">
                        <div class="h-100">
                            <h5 class="mb-1">{{ explode(' ', $student->name)[0] }}</h5>
                            <p class="mb-0 font-weight-bold text-sm">Étudiant</p>
                            <p class="mb-0 font-weight-bold text-sm">Inscrit(e) dans la filière : {{ $student->sector->name }}</p>
                                ...
                                <div class="card-header pb-0 p-3">
                                    <div class="row">
                                        <div class="col-md-8 d-flex align-items-center">
                                            ...
                                            @if(session('success'))
                                                <div class="alert-message color-green">{{ session('success') }}</div>
                                            @endif
                                        </div>
                        ...
                        <div class="col-12 col-xl-6 form_container">
                            <div class="card h-100">
                                <div class="card-header pb-0 p-3">
                                    <div class="row">
                                        <div class="col-md-8 d-flex align-items-center">
                                            <h6 class="mb-0">Mise à jour</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body p-3">
                                    <ul class="list-group">
                                        <form action="{{ route('students.profile.update', ['id' => $student->id]) }}" enctype="multipart/form-data" method="POST" class="needs-validation" novalidate>
                                            @csrf
