...
<!-- -->
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <!--4 carré au haute de page-->
    <div class="container-fluid py-4">
      <div class="row">

      <!--2 carré au 3 ligne de page-->
      <div class="row mt-4">
        ...
        <div class="col-lg-7">
          <div class="card z-index-2">
            <div class="card-header pb-0">
             ...
             <div class="card-body p-3">
              <div class="chart">
                <canva id="chart-line" class="chart-canvas" height="300"></canva>
              </div>
            </div>
          </div>
        </div>
      </div>
      <!--2 formulaire de 4 ligne-->
      <div class="row my-4">
    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Paramètres</h5>
          <p>Les paramètres de l'espace enseignant</p>
        </div>
