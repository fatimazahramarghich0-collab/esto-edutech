...
<style>
    ...
    body {
        ...
        /* Remplacez cette couleur par la couleur de fond de votre choix */
    }

    .container {
        max-width: 1200px;
        /* Ou une autre largeur maximale si nécessaire */
        width: 100%;
        padding: 0 15px;
        margin-right: 20px;
...
<body class="g-sidenav-show bg-gray-100">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100 container">
        <!-- Navbar -->
                            ...
                            <div class="card-body p-3">
                                ...
                                @foreach ($subjects as $subject)
                                    <li class="list-group-item border-0 ps-0 pt-0 text-sm">
                                        <strong style="color:gray">{{ $subject->name }}</strong>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
                ...
                <div class="container-divs">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-3">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Charge Horaire:</strong> {{ $user->hourlyLoads->sum('charge') }}
                                    </li>
                    ...
                    <div class="col-12 col-xl-6 form_container">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-3">
                                <ul class="list-group">
                                    <form action="{{ route('teachers.profile.update', ['idTeacher' => $user->id]) }}" enctype="multipart/form-data" method="POST" class="needs-validation" novalidate>
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="photo" name="photo" class="form-control" alt="photo">
    ...
    <script>
        import {
            Helpers as Scrollbar
        } from "../../../../../public/studentFile/js/helpers.js";
