...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbarAdmin :pageName="'Etudiant'" />
        ...
        <div class="container-fluid py-4">
            <div class="row">
                    ...
                    <div class="card-body pt-sm-3 pt-0">
                        <div class="ms-md-auto pe-md-2 d-flex align-items-center">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="search-input" class="form-control" placeholder="Rechercher ici...">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-3">
                    <div class="card-body pt-sm-3 pt-0">
                        <div class="d-flex">
                            <button class="btn bg-gradient-primary w-100 px-3 mb-2 active" onclick="importStudent(event)">
                                <i class="fa-solid fa-arrow-up-from-bracket"></i> &nbsp;Importer CSV
                            </button>
                            <!-- Modal for the import form -->
                            <div class="import_container">
                                <!-- This is where the modal import content will be loaded -->
                            </div>
                            <button class="btn bg-gradient-primary w-100 px-3 mb-2 ms-2" onclick="createStudent(event)"><i class="fa-solid fa-plus" style="color: #ffffff;"></i> Ajouter
                            </button>
